...
- use git-mcp-server for git operation
...
[byterover-mcp]
- when need to check for error and warning remember to use ide-getDiagonostic mcp tools
- remember to run ide-getDiagonostics and fix error, warning after edit, create files or multiple files
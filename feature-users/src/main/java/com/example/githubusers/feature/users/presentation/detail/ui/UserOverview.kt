...
fun UserOverview(userDetail: UserDetail, modifier: Modifier = Modifier) {
    Column(
        ...
        // Account Information
        AccountInformationCard(userDetail = userDetail)

        // Statistics
        StatisticsCard(userDetail = userDetail)

        // Additional Info
        if (userDetail.hireable != null || userDetail.type != "User") {
            AdditionalInfoCard(userDetail = userDetail)
        }
    }
}

@Composable
private fun AccountInformationCard(userDetail: UserDetail, modifier: Modifier = Modifier) {
    Card(
...
@Composable
private fun StatisticsCard(userDetail: UserDetail, modifier: Modifier = Modifier) {
    Card(
        modifier = modifier.fillMaxWidth(),
        elevation = CardDefaults.cardElevation(defaultElevation = 2.dp)
    ) {
...
@Composable
private fun AdditionalInfoCard(userDetail: UserDetail, modifier: Modifier = Modifier) {
    Card(
        modifier = modifier.fillMaxWidth(),
        elevation = CardDefaults.cardElevation(defaultElevation = 2.dp)
    ) {

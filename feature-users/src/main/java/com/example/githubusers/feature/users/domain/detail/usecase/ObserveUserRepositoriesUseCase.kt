...
/**
 * Use case for observing user's repositories with pagination.
 */
@Reusable
class ObserveUserRepositoriesUseCase @Inject constructor(private val repository: UserDetailRepository) {
    /**
     * Execute the use case to observe user's repositories.
     *
     * @param username The username whose repositories to observe

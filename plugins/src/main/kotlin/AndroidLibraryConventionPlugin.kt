...
import com.example.githubusers.buildlogic.disableUnnecessaryAndroidTests
...
class AndroidLibraryConventionPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        with(target) {
            ...
            // Apply project-wide quality conventions (detekt will only configure when present)

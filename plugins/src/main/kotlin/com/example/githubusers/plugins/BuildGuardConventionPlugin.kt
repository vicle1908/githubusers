...
class BuildGuardConventionPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        ...
        // Always wire the guard task into 'check'; enforcement is toggled by the project property
        target.tasks.named("check").configure { dependsOn("verifyNoLocalBuildLogic") }
    }
}

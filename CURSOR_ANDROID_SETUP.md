...
1. **JetBrains inspections** for accurate analysis
1. **Gradle-based linting** for code quality
...
1. Check Java runtime configuration
...
1. Run `./gradlew --version` to verify Gradle works
1. Use Gradle extension commands in Command Palette

## Best Practices

1. **Use Gradle for builds**: Always use `./gradlew` commands
1. **Trust successful builds**: If Gradle builds succeed, the code is correct
1. **Use JetBrains for analysis**: For accurate linting, use IntelliJ/Android Studio
1. **Leverage Cursor AI**: Use Cursor's AI features for code completion and assistance
1. **Regular sync**: Run `./gradlew build` regularly to catch issues early

## Verification Steps

1. **Test build**: `./gradlew app:assembleDebug`
1. **Test linting**: `./gradlew ktlintCheck`
1. **Test formatting**: `./gradlew ktlintFormat`
1. **Verify extensions**: Check that Kotlin and Gradle extensions are active
1. **Test AI features**: Use Cursor's chat and inline editing features

...
2. **Direct Control**: Navigation3Controller manages back stack directly
3. **Testability**: Back stack is observable (StateFlow) and easy to assert in tests
4. **Flexibility**: Supports deep link and typed navigation patterns
5. **Deep Link Support**: Comprehensive handling for app and web schemes
...
2. Implement saved state handling for process death

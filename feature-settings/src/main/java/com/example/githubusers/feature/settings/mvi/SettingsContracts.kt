...
sealed interface SettingsIntent {
    ...
    data class SetPagingSize(val size: Int) : SettingsIntent

    data class ToggleShowImages(val enabled: Boolean) : SettingsIntent

    data class ToggleAnalytics(val enabled: Boolean) : SettingsIntent

    data class ToggleCrashReports(val enabled: Boolean) : SettingsIntent

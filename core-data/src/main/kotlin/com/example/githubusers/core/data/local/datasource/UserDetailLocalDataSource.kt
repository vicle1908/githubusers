...
class UserDetailLocalDataSourceImpl @Inject constructor(
    private val userDetailDao: UserDetailDao
) : UserDetailLocalDataSource {
    
    override fun getUserDetail(login: String): Flow<UserDetailEntity?> = 
        userDetailDao.getUserDetailByLogin(login)
        
    override suspend fun getUserDetailSync(login: String): UserDetailEntity? = 
        userDetailDao.getUserDetailByLoginSync(login)
        
    override suspend fun insertUserDetail(userDetail: UserDetailEntity) = 
        userDetailDao.insertUserDetail(userDetail)
        
    override suspend fun deleteUserDetail(login: String) = 
        userDetailDao.deleteUserDetailByLogin(login)
        
    override suspend fun deleteUserDetailsOlderThan(timestamp: Long) = 
        userDetailDao.deleteUserDetailsOlderThan(timestamp)
}

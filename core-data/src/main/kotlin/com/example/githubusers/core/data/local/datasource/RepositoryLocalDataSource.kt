...
class RepositoryLocalDataSourceImpl
    ...
    constructor(
        ...
        override fun getRepositories(ownerLogin: String): Flow<List<RepositoryEntity>> = repositoryDao.getRepositoriesByOwner(ownerLogin)
        ...
        override suspend fun insertRepositories(repositories: List<RepositoryEntity>) = repositoryDao.insertRepositories(repositories)

        override suspend fun deleteRepositories(ownerLogin: String) = repositoryDao.deleteRepositoriesByOwner(ownerLogin)

        override suspend fun deleteRepositoriesOlderThan(timestamp: Long) = repositoryDao.deleteRepositoriesOlderThan(timestamp)

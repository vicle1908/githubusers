...
class TestNavigationDelegate : NavigationDelegate {
    ...
    sealed class NavigationEvent {
        ...
        data class PopBackStackTo(val destination: NavigationDestination, val inclusive: Boolean) : NavigationEvent()
        data class ClearBackStackAndNavigate(val destination: NavigationDestination) : NavigationEvent()
    }
    ...
    override suspend fun popBackStackTo(destination: NavigationDestination, inclusive: Boolean) {
    ...
    val navigatedDestinations: List<NavigationDestination>
        get() = _navigationHistory.mapNotNull { event ->
            when (event) {

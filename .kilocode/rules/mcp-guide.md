...
2. **Confirm** recent decisions with the user when context is missing

### After Successful Operations

1. **Store** important findings: `mcp_openmemory_add-memory`
2. **Update** local docs or trackers as needed (confirm with the user)
3. **Save** implementation plans in the planning tool or OpenMemory when they need to persist

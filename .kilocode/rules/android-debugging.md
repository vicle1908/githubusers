...
2. **ALWAYS** use Mobile-MCP for app launch and UI interaction
3. **ALWAYS** use Gradle MCP for builds
4. **NEVER** use manual ADB without explicit approval
5. **NEVER** use `./gradlew` directly

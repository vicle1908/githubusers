...
For guidance on multi-AI development with Git Worktrees, see:

- `docs/GIT_WORKTREE_MULTI_AI_GUIDE.md`
- `docs/GIT_WORKTREE_IMPLEMENTATION_SUMMARY.md`

Use ByteRover to store worktree-specific patterns and plans.

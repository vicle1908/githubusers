...
import com.example.githubusers.feature.search.data.paging.EnhancedSearchPagingSource
...
/**
 * Enhanced implementation of SearchRepository using GitHub API with improved URL encoding
 */
@Singleton
class EnhancedSearchRepositoryImpl
    @Inject
    constructor(
        ...
        override fun getTrendingUsers(): Flow<PagingData<SearchResult>> =
            Pager(
                config =
                    PagingConfig(
                        pageSize = PAGE_SIZE,

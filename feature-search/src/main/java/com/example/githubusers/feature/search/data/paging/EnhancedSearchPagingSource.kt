...
/**
 * Enhanced paging source for search results with improved URL encoding and error handling
 */
class EnhancedSearchPagingSource(
     ...
     */
    internal fun buildEncodedSearchQuery(
        baseQuery: String,
        filter: SearchFilter,
    ): String {

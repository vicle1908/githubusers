...
### **For Developers**
 ...
 1. **Follow Android development standards** from `android.mdc`
 1. **Request multi-AI consultation** for critical decisions
 1. **Integrate knowledge management** using ByteOver + OpenMemory
 1. **Store important knowledge** in both systems appropriately
 1. **Use external services** for latest documentation and practices

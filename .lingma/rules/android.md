...
- Use shared composables for common UI patterns
- Implement `SearchableListScaffold` for paged list screens with search
- Follow feature-owned UI pattern where appropriate
- Maintain consistency in error handling and loading states

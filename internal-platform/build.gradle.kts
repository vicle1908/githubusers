...
val internalModules = listOf(
    ...
    "com.example.githubusers:core-domain" to libs.versions.coreDomainModule.get(),
    ...
    "com.example.githubusers:feature-users-list" to libs.versions.featureUsersListModule.get(),
    "com.example.githubusers:feature-users-detail" to libs.versions.featureUsersDetailModule.get(),
